                ...
                <div class="panel-body">
                        ...
                        <div id="carousel1" class="carousel slide slider" data-ride="carousel">
                            <div class="thumbs">
                                ...
                                <ol class="carousel-indicators">
                                    ...
                                    @empty
                                    <li data-target="#carousel1" data-slide-to="0" class=""><img alt="{{isset($item->Name) ? $item->Name : ''}}" src="/images/slide_office.jpg"></li>
                                    @endforelse 
                                    @else
                                    <li data-target="#carousel1" data-slide-to="0" class=""><img alt="{{isset($item->Name) ? $item->Name : ''}}" src="/images/slide_office.jpg"></li>
                                    @endif
                            ...
                            <div class="carousel-inner">
                                ...
                                @empty
                                <div class="item">
                                    <img  alt="{{isset($item->Name) ? $item->Name : ''}} src="/images/slide_office.jpg">
                                </div>
                                @endforelse 
                                @else
                    ...
                    <div class="col-sm-6 pl_25">
                        ...
                        <div class="specifications">
                            <h5>{{Lang::get('main.title_office')}}</h5>
