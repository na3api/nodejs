  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Locations#getLoc
         * @methodOf lbServices.Locations
         *
         * @description
         *
         ...
         */
        "getLoc": {
          url: urlBase + "/locations/getloc",
          method: "GET"
        },

        // INTERNAL. Use Games.location() instead.
        "::get::Games::location": {
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Messages.user() instead.
        "::get::Messages::user": {
...
/**
 * @ngdoc object
 * @name lbServices.Games
 * @header lbServices.Games
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Games` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#create
         * @methodOf lbServices.Games
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Games` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/Games",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#createMany
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#findById
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#updateAll
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#deleteById
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#prototype$updateAttributes
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#createChangeStream
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#updateOrCreate
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#destroyById
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#removeById
         * @methodOf lbServices.Games
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Games#modelName
    * @propertyOf lbServices.Games
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Games`.
    */
    R.modelName = "Games";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Games#location
         * @methodOf lbServices.Games
         *
         * @description
         *
        ...
        R.location = function() {
          ...
          var action = TargetResource["::get::Games::location"];
    ...
    */
    R.modelName = "Messages";
        ...
        R.user = function() {
          ...
          var action = TargetResource["::get::Messages::user"];
          return action.apply(R, arguments);
        };
