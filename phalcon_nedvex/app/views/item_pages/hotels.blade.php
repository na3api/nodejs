                ...
                <div class="panel-body">
                        ...
                        <div id="carousel1" class="carousel slide slider" data-ride="carousel">
                            <div class="thumbs">
                                ...
                                <ol class="carousel-indicators">
                                    ...
                                    @empty
                                    <li data-target="#carousel1" data-slide-to="0" class=""><img alt="{{isset($item->Name) ? $item->Name : ''}}" src="/images/slide_hotel.jpg"></li>
                                    @endforelse 
                                    @else
                                    <li data-target="#carousel1" data-slide-to="0" class=""><img alt="{{isset($item->Name) ? $item->Name : ''}}" src="/images/slide_hotel.jpg"></li>
                                    @endif
                            ...
                            <div class="carousel-inner">
                                ...
                                @empty
                                <div class="item">
                                    <img  alt="{{isset($item->Name) ? $item->Name : ''}}" src="/images/slide_hotel.jpg">
                                </div>
                                @endforelse 
                                @else
                    ...
                    <div class="col-sm-6 pl_25">
                        ...
                        <div class="hotel_stars">
                            @if(isset($item->NumberOfStars))
                                @for($i = 0; $i < $item->NumberOfStars; $i++)
                                    <span></span>
                                @endfor
                                <p>{{$item->NumberOfStars}} {{Items::endingWords('stars', $item->NumberOfStars)}}</p>
                            @endif
                        </div>                     
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="specifications">
                            ...
                            <ul class="list-unstyled">
                                ...
                                {!!isset($item->NumberOfRooms) && $item->NumberOfRooms ? '<li>'.$item->NumberOfRooms.' '.Items::endingWords('rooms', $item->NumberOfRooms).'</li>' : '' !!} 
                            </ul>
                            <ul class="list-unstyled"> 
                                @if((isset($item->WinterVacation) && $item->WinterVacation) && (isset($item->SummerVacation) && $item->SummerVacation))
                                    <li>{{Lang::get('main.summer_winter')}}</li>
                                @elseif(isset($item->WinterVacation) && $item->WinterVacation)
                                    <li>{{Lang::get('main.winter')}}</li>
                                @elseif(isset($item->SummerVacation) && $item->SummerVacation)
                                    <li>{{Lang::get('main.summer')}}</li>
                                @endif
                            ...
                            <ul class="list-unstyled">
                                ...
                                {!!isset($item->BuildingMaterials) ? '<li>'. Lang::get('enums.BuildingMaterials.'.$item->BuildingMaterials).'</li>' : ''!!}
